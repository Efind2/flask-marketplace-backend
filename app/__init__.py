...
# Import Config yang sudah diperbarui
...
def create_app():
    ...
    # --- TAMBAHKAN BARIS INI UNTUK MEMASTIKAN FOLDER UPLOAD ADA ---
    # Membuat folder upload jika belum ada
    os.makedirs(app.config['UPLOAD_FOLDER'], exist_ok=True)
    logger.info(f"Folder upload: {app.config['UPLOAD_FOLDER']} (dibuat jika belum ada).")
    # --- AKHIR TAMBAH ---
...
# Jika Anda menjalankan langsung (misal: python app.py)
# app = create_app()
